    ...
    <nav className={`navbar ${sticky ? 'sticky' : ''}`}>
      <div className="container">
        ...
        <ul className={`nav-links ${menuOpen ? 'active' : ''}`}>
          ...
          <li><Link to='Divisions' smooth={true} offset={-50} duration={500}>Program</Link></li>
          ...
          <li><Link to='contect us' smooth={true} offset={-50} duration={500} className='btn'>Contact us</Link></li>
        </ul>
